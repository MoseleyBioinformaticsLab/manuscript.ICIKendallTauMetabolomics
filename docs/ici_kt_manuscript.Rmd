...
We were also curious about the utility of the ICI-Kt methodology in creating metabolomics feature-feature networks with large amounts of missing values, so we evaluate the partitioning of networks by Reactome pathways [@joshi-topeReactomeKnowledgebaseBiological2005] after network creation using different correlation measures.
