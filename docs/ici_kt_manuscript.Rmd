...
::: {custom-style="MDPI_3.1_text"}
Of the 6105 initially downloaded, 711 were kept for further analysis.
:::
...
::: {custom-style="MDPI_3.1_text"}
Predicted reactome pathway annotations for analyzable Metabolomics Workbench datasets were parsed from the previous work by Huckvale et al.  [@joshi-topeReactomeKnowledgebaseBiological2005; -@huckvaleHighQualityPredictedPathway2025].
...
Code and data used in the results for this manuscript are available on Zenodo: https://zenodo.org/doi/10.5281/zenodo.6309187 
