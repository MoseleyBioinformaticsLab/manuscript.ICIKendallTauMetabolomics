...
To test and validate ICI-Kt methodology, we used a variety of simulated datasets with different types and amounts of missingness, and real metabolomics experiments from Metabolomics Workbench measured using a variety of analytical platforms, comparing ICI-Kt to Kendall-tau, Spearman and Pearson correlations.

**Results**: We found that ICI-Kt performs better than either the regular Kendall-tau, Spearman, or Pearson correlation methods when left-censored values are present, both for the detection of outlier samples and the construction of metabolite-metabolite networks.
