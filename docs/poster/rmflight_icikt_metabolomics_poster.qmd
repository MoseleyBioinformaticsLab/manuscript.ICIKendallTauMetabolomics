...
1. Metabolomics data missing values are not randomly distributed (i.e. are MNAR).
...
1. ICI-Kt and Pearson correlation demonstrate better performance in removing outlier samples.
