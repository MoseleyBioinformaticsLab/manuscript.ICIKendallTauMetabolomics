#let poster(
  ...
  set page(
    ...
    height: height,
    margin: 
      (top: 0.5in, left: 1in, right: 1in, bottom: 1.5in),
    footer: [
      #set align(center)
      #set text(32pt)
      #block(
        ...
        radius: 10pt,
        [
          #text(font: "CommitMono", size: footer_url_font_size, footer_url) 
          #h(1fr) 
          #text(font: "CommitMono", size: footer_text_font_size, footer_text) 
          #h(1fr) 
          #text(font: "CommitMono", size: footer_url_font_size, footer_email_ids)
        ]
      )
    ]
  )
