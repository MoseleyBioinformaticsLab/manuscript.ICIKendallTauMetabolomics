...
Prior to calculations, all metabolite values <= 0 were set to R's missing indicator, `NA`, so that zeros and actually missing indicated values were treated identically.